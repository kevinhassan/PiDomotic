...
int main(void) {
    ...
    cv::Point crossingLine[2];//Vecteur

    int carCount = 0;

    // capture.open("CarsDrivingUnderBridge.mp4");
    ...
    /*
      Renvoie les images capturées vers les frames
     */
    ...
    while (capture.isOpened() && chCheckForEscKey != 27) {
        ...
        /*
          Selectionner les pixels dont le seuil est au dessus de 255 (blanc)
